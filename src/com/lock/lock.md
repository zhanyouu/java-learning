...
![](../../../resources/lock/1.png)

AQS使用一个FIFO的队列表示排队等待锁的线程，队列头节点，它不与任何线程关联。其他的节点与等待线程关联，每个节点维护一个等待状态waitStatus。
